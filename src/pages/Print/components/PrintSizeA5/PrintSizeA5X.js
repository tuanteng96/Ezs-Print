...
export const PrintSizeA5X = React.forwardRef((props, ref) => {
  return (
    <div ref={ref} className="print-ezs print-A5 print-A5x">
        ...
        <div className="body-print text-center">
          ...
          <div className="print-infor ">
            <div className="d-flex  pb-2">
              <div className="text-left font-weight-800 w-150px">
          ...
          <table className="table table-bordered table-bordered-dark ">
            <thead>
              <tr>
              <th className="font-weight-800">STT</th>
                <th className="font-weight-800">Tên sản phẩm</th>
                <th className="font-weight-800">Mã</th>
