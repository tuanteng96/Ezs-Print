...
export const PrintSizeA5XuatKho = React.forwardRef((props, ref) => {
  return (
    <div ref={ref} className="print-ezs print-A5 print-A5xuatkho">
      ...
      <div className="print-body">
        ...
        <div className="body-print text-center">
          ...
          <table className="table table-bordered table-bordered-dark ">
            ...
            <tfoot>
              <tr>
                <td colSpan="7" className="font-weight-800 text-left">Tổng số tiền :</td>
