    ...
    <div ref={ref} className="print-ezs print-k80 print-k80X pr-104r">
      ...
      <div className="body-print text-center">
        ...
        <table className="table table-bordered table-bordered-dark ">
          <thead>
          <tr>
            <th className="vertical-align-middle font-weight-800 min-w-180px">Tên sản phẩm</th>
            <th className="vertical-align-middle font-weight-800 w-60px">Đơn vị</th>
            <th className="vertical-align-middle font-weight-800 w-60px">Số lượng</th>
          </tr>
        </thead>
        <tbody>
        {Array(2)
