...
export const PrintSizeK80C = React.forwardRef((props, ref) =>{
    return (
    <div ref={ref} className="print-ezs print-k80 pl-6">
      ...
      <div className="body-print text-center">
        ...
        <table className="table table-bordered table-bordered-dark ">
          <thead>
          <tr>
            <th className="font-weight-800 min-w-170px">Tên mặt hàng</th>
        ...
        <div className="total-payment ">
          ...
          <div className="d-flex justify-content-between">
            ...
            <p className="total-money-item font-weight-800">9.200.000<span className="font-weight-normal">VNĐ</span></p>
          </div>
          <div className="d-flex justify-content-between">
            <p className="total-money-item font-weight-bold">
          ...
          <div className="d-flex justify-content-between">
            ...
            <p className="total-money-item font-weight-800">8.000.000<span className="font-weight-normal">VNĐ</span></p>
          </div>
        </div>
        <div className="pay-money">
          ...
          <div className="d-flex justify-content-between">
            ...
            <p className="total-money-item font-weight-bold">1.000.000<span className="font-weight-normal">VNĐ</span></p>
          </div>
          <div className="d-flex justify-content-between">
            <p className="total-money-item font-weight-bold">
        ...
        <div className="history-total">
          ...
          <div className="d-flex justify-content-between text-left border-bottom font-weight-bold">
            ...
            <p className="payments mb-0 py-2 w-110px text-left">Tiền mặt</p>
          ...
          <div className="d-flex justify-content-between text-left border-bottom font-weight-bold">
            ...
            <p className="payments mb-0 py-2 w-110px text-left">Ví</p>
            <p className="total-payments mb-0 py-2 font-weight-bold">
          ...
          <div className="d-flex justify-content-between text-left border-bottom font-weight-bold">
            <p className="date mb-0 py-2 mr-2">05/11/2021</p>
            <p className="payments mb-0 py-2 w-110px text-left">Chuyển khoản</p>
            <p className="total-payments mb-0 py-2 font-weight-bold">
              1.000.000<span className="font-weight-normal">VNĐ</span>
            </p>
          </div>
