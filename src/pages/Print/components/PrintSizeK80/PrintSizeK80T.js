...
export const PrintSizeK80T = React.forwardRef((props, ref) =>{
    return (
        <div ref={ref} className="print-ezs print-k80 print-k80t pr-104r ">
        ...
        <div className="body-print text-center">
          ...
          <div className="print-signature d-flex justify-content-between font-weight-800 w-100 pt-4">
              <div className="h-300px text-left">Người lập phiếu</div>
              <div className="h-300px text-center">Người nộp tiền</div>
