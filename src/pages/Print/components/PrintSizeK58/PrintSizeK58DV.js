...
export const PrintSizeK58DV = React.forwardRef((props, ref) => {
  return (
    <div ref={ref} className="print-ezs print-k58 print-k58dv pr-104r">
      ...
      <div className="body-print text-center">
        ...
        <div className="print-infor ">
          ...
          <div className="name-hotline d-flex justify-content-between py-2">
            <div className="name-hotline-item text-left font-weight-bold">
              Điện thoại<span className="dotted-item"> :</span>
            </div>
        ...
        <table className="table table-bordered table-bordered-dark ">
          <thead>
            <tr>
              <th className="font-weight-800 vertical-align-middle">Tên mặt hàng</th>
              <th className="font-weight-800 vertical-align-middle">Buổi thứ</th>
              <th className="font-weight-800 vertical-align-middle">Tổng buổi</th>
            </tr>
          </thead>
          <tbody>
            <tr>
            ...
            <tr className="font-weight-bold">
              ...
              <td className="font-weight-bold vertical-align-middle">02</td>
              <td className="vertical-align-middle">
                <p className="into-money mb-0">10</p>
              </td>
            </tr>
          </tbody>
        </table>
        <div className="">
          <p className="text-left"><span className="font-weight-800">Ghi chú :</span> Khách dị ứng với tinh dầu nghệ, khách đã mang theo thuốc triệt lông</p>
        </div>
