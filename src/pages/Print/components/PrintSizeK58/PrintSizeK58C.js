...
export const PrintSizeK58C = React.forwardRef((props, ref) => {
  return (
    <div ref={ref} className="print-ezs print-k58 pr-104r ">
      ...
      <div className="body-print text-center">
        ...
        <div className="total-payment ">
          <div className="total-money">
            <div className="d-flex justify-content-between">
              ...
              Lý do chi <span className="dotted-item">:</span>
              </p>
        ...
        <div className="print-signature d-flex justify-content-between font-weight-800">
            ...
            <div className="h-70px">Người nộp tiền</div>
            <div className="h-70px">Thủ quỹ </div>
        </div>
