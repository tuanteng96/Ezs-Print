...
export const PrintSizeA4TTKH = React.forwardRef((props, ref) => {
  return (
    <div ref={ref} className="print-ezs print-A4 print-A4TTKH">
      ...
      <div className="print-body">
        ...
        <div className="body-print text-center">
          ...
          <div className="print-infor pb-5">
            ...
            <div className="name-hotline d-flex justify-content-between py-4">
            ...
            <div className="name-email d-flex justify-content-between pb-4">
            ...
            <div className="name-birthday d-flex justify-content-between">
              <div className="name-birthday-item text-left font-weight-bold w-150px">
